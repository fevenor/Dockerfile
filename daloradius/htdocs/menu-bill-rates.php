...
<div id="sidebar">
                                ...
                                <h3><?php echo $l['menu']['Track Rates'];?></h3>
	<ul class="subnav">
			...
			<select name="ratename" size="1">
				<option value="<?php if (isset($billing_date_ratename)) echo $billing_date_ratename; else echo ""; ?>">
					<?php if (isset($billing_date_ratename)) echo $billing_date_ratename; else echo $l['menu']['Choose Rate'];?>
				</option>
			<?php
			...
			?>			
                        ...
                        <div id="chooserSpan" class="dateChooser select-free"
                                ...
                                <h3><?php echo $l['menu']['Rates Management'];?></h3>
                                <ul class="subnav">
