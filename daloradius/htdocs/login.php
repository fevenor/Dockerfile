		...
		<h3><? echo $l['text']['LoginPlease'] ?></h3>
				...
				<form name="login" action="dologin.php" class="sidebar" method="post" >
					<ul class="subnav">
						...
						<br/><br/><br/>
						<input class="sidebutton" type="submit" value="<?php echo $l['button']['Login'] ?>" tabindex=3 />
					</ul>
				</form>
