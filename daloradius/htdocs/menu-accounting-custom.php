...
?>	
		<div id="sidebar">
				...
				<h2><?php echo $l['menu']['Accounting'] ?></h2>
				
				<h3><?php echo $l['menu']['Custom Query'] ?></h3>
				<ul class="subnav">
...
<div id="chooserSpan" class="dateChooser select-free" style="display: none; visibility: hidden; width: 160px;"></div>
		...
		<h109><?php echo $l['button']['Where']; ?></h109> <br/>
			...
			<select name="operator" size="1" class="generic" >
				<option value="="> <?php echo $l['button']['Equals'];?> </option>
				<option value="LIKE"> <?php echo $l['button']['Contains'];?> </option>
			</select>
			</center>
		...
		<a class="table" href="javascript:SetChecked(1,'sqlfields[]','acctcustomquery')"><?php echo $l['button']['All'];?></a>
		<a class="table" href="javascript:SetChecked(0,'sqlfields[]','acctcustomquery')"><?php echo $l['button']['None'];?></a>
		<br/><br/>
