...
<div id="sidebar">
                                ...
                                <h3><?php echo $l['menu']['Track PayPal Transactions'];?></h3>
	<ul class="subnav">
		...
		<h109><?php echo $l['all']['VendorType']; ?></h109> <br/>
                        <select name="vendor_type" size="1">
                                <option value="<?php if (isset($billing_paypal_vendor_type)) echo $billing_paypal_vendor_type; else echo "%"; ?>">
                                        <?php if (isset($billing_paypal_vendor_type)) echo $billing_paypal_vendor_type; else echo $l['button']['Any']; ?>
                                </option>
				<option value=""></option>
				<option value="%"><?php echo $l['button']['Any'];?></option>
		...
		<h109><?php echo $l['all']['PaymentStatus']; ?></h109> <br/>
                        <select name="payment_status" size="1">
                                <option value="<?php if (isset($billing_paypal_paymentstatus)) echo $billing_paypal_paymentstatus; else echo "%"; ?>">
                                        <?php if (isset($billing_paypal_paymentstatus)) echo $billing_paypal_paymentstatus; else echo $l['button']['Any']; ?>
                                </option>
				<option value=""></option>
			...
			<br/><br/>
                ...
                <a class="table" href="javascript:SetChecked(1,'sqlfields[]','billpaypaltransactions')"><?php echo $l['button']['All']?></a>
                <a class="table" href="javascript:SetChecked(0,'sqlfields[]','billpaypaltransactions')"><?php echo $l['button']['None']?></a>
