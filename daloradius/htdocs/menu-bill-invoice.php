...
<div id="sidebar">
	...
	<h3><?php echo $l['menu']['Invoice Management'];?></h3>
	<ul class="subnav">
		...
		<li><a href="javascript:document.invoicelist.submit();"><b>&raquo;</b><?php echo $l['button']['ListInvoices'] ?></a>
			...
			<?php
				...
				populate_invoice_status_id($l['menu']['Select Invoice Status'],"invoice_status_id","form", '', $edit_invoice_status_id);
			?>
	...
	<ul class="subnav">
			...
			<form name="billinvoicereport" action="bill-invoice-report.php" method="get" class="sidebar">
				...
				<?php
				        include_once('include/management/populate_selectbox.php');
				        populate_invoice_status_id($l['menu']['All Invoice Types'], "invoice_status", "form", "", "%");
				?>
